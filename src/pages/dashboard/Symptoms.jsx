          ...
          <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-max table-auto text-left">
                <thead>
                  <tr>
                    <th className="border-b border-gray-700/50 py-3 px-4 text-white">Date</th>
                    <th className="border-b border-gray-700/50 py-3 px-4 text-white">Symptoms</th>
                    <th className="border-b border-gray-700/50 py-3 px-4 text-white">Severity</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="even:bg-gray-700/50">
